...
<body>
      ...
      <div class="container">
          <div class="row">
              ...
              <ul class="nav">
						  ...
						  <li class="has-sub">
                              <a href="javascript:void(0)"  class="active">Prestamos</a>
                              <ul class="sub-menu">
  ...
  <?PHP
    ...
    $result2=mysqli_query($link2,"SELECT * FROM prestamos");
     ...
     echo "<thead class='thead-light'><tr><th scope='col'> ID LIBRO</th><th scope='col'> IMAGEN </th><th scope='col'> NOMBRE </th><th scope='col'> SE PRESTÓ A </th><th scope='col'> FECHA DE ENTREGA </th><th scope='col'> FECHA DE REGRESO </th></tr></thead>";
     ...
     while($resultado2 = mysqli_fetch_array($result2)){
      ...
      $result = mysqli_query($link, "select nombre from usuario WHERE id_usuario='$id2'");
     while ($row = mysqli_fetch_array($result)) {
         $nombreU = $row['nombre'];
     }

     $link3 = mysqli_connect("localhost", "root", "");
      mysqli_select_db($link3, "libreria");
      $result3 = mysqli_query($link3, "select nombre, imagen from libro WHERE id_libro='$id3'");
     while ($row3 = mysqli_fetch_array($result3)) {
         $nombreL = $row3['nombre'];
         $imagen = $row3['imagen'];
     }

         echo "<tr class='table-row table-hover' data-id='$id3'>";
         echo "<td>$id3</td>";
