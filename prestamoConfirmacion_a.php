<?php
  ...
  if ($days > 20) {
    header("Location: prestamo_u.php?libro=" . urlencode($id_libro) . "&nombre=" . urlencode($nombreLibro) . "&propietario=" . urlencode($propietario));
    exit;
  }
  ...
  $fechaFutura = date('Y-m-d', strtotime($fechaActual . ' + ' . $days . ' days'));
  $fechaFuturaFormateada = strftime('%d/%m/%Y', strtotime($fechaFutura));
  echo "Fecha actual: " . $fechaActual . "<br>";
  echo "Fecha futura (" . $days . " días después): " . $fechaFuturaFormateada;
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 align-self-center">
          <div class="row">
            <div class="col-lg-12">
              <form id="contact" action="prestamoRealizado_a.php" method="post">
                <div class="row">
                  <div class="col-lg-12">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="book">Propietario</label>
                      <input type="text" value='<?php echo "$propietario"; ?>' name="propietario" readonly>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" value=<?php echo "$fechaActualFormateada"; ?> name="entrega" readonly>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="date">Fecha Límite</label>
                      <input type="text" value=<?php echo "$fechaFuturaFormateada"; ?> name="regreso" readonly>
                    </div>
                  </div>
                  <div class="col-lg-6">
                  <a href="libros_a.php" class="btn btn-primary" style="background-color: #a12c2f; border-radius: 30px; border-color: #a12c2f; padding: 12px 25px; text-transform: uppercase; font-size: 13px;">Cancelar</a>
                  </div>
                  <div class="col-lg-6 d-flex justify-content-end">
                    <?php
                    echo "<input type='hidden' name='libro' value=$id_libro>";
                    ?>
                    <button type="submit" class="btn btn-primary bg-success">Confirmar</button>
                  </div>
                </div>
              </form>
            </div>
