    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 align-self-center">
          <div class="row">
            <div class="col-lg-12">
              <form id="contact" action="validar_actualizar_a.php" method="post">
                <div class="row">
                  <div class="col-lg-12">
                  ...
                  <div class="col-lg-4">
                    <fieldset>
                    <?php echo " Nombre: <input name='nombre' type='text' id='nombre' value='$nom' required=''>"; ?>
                  </fieldset>
                  </div>
                  <div class="col-lg-4">
                    <fieldset>
                    <?php echo "Correo: <input name='email' type='text' id='email' pattern='[^ @]*@[^ @]*' value='$correo' required=''>"; ?>
                  </fieldset>
                  </div>
                  <div class="col-lg-4">
                    <fieldset>
                    <?php echo "Contraseña: <input name='password' type='password' id='password' value='' required=''>"; ?>
                    </fieldset>
                  </div>
                  <div class="col-lg-4">
                    <fieldset>
                    <?php echo "Nueva Contraseña: <input name='newpassword' type='password' id='newpassword' value='' required=''>"; ?>
                    </fieldset>
                  </div>
                  <?php echo " <input type='hidden' name='id1' value='$id'>"; ?>

                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="form-submit" class="button">Actualizar</button>
                    </fieldset>
                  </div>
                </div>
              </form>
