      ...
      <div class="container">
          <div class="row">
              ...
              <ul class="nav">
                          ...
                          <li><a href="sesion_i.php" class="active">Iniciar Sesion</a></li> 
                      </ul>        
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 align-self-center">
          <div class="row">
            <div class="col-lg-12">
              <form id="contact" action="validar_usuario.php" method="post">
                <div class="row">
                  <div class="col-lg-12">
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="form-submit" class="button">Iniciar Sesion</button>
                    </fieldset>
                  </div>
                </div>
              </form>
